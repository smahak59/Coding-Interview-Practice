...
//This question can also be done using cummulative sum. Take an integer
// array of size maximum time range i.3 from 0000 to 2400 and mark all as zeros.
//For each train mark Arr[arrival time of that train] = Arr[arrival time of that train]+1 and
// Arr[departure time+1 ] = Arr[departure time +1]-1
//Find the largest value in the array in the end. That will be the answer.